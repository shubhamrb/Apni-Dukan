...
import com.mponline.vendorApp.livedata.ConnectionLiveData
import com.mponline.vendorApp.model.UserCurrentAddress
                            ...
                            for (i in 0..this?.size - 1) {
                                if (this.get(i)?.locality != null) {
                                    if (CommonUtils.isValidGPSName(this.get(i)?.locality) && (!TextUtils.isEmpty(
                                        ...
                                        ))) && ((!TextUtils.isEmpty(this.get(i)?.getAddressLine(0)) && CommonUtils.isValidGPSName(
