...
public class PaytmMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.paytm_activiy);
        progressBar = (ProgressBar) findViewById(R.id.progressBar);
        btnPayNow = (Button) findViewById(R.id.txnProcessBtn);
        btnPayNow.setOnClickListener(PaytmMainActivity.this);
    }
    ...
    public void btnProcessEvent (){
        ...
        midString = "CAvRVp59211200813874";//mid.getText().toString();
        ...
        if(errors.equalsIgnoreCase("")){
            ...
            TransactionManager transactionManager = new TransactionManager(paytmOrder, new PaytmPaymentTransactionCallback(){
                ...
                public void onTransactionResponse(Bundle bundle) {
                    Toast.makeText(PaytmMainActivity.this, "Response (onTransactionResponse) : "+bundle.toString(), Toast.LENGTH_SHORT).show();
                }
