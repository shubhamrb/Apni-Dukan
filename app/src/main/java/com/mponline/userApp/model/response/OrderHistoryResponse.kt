...
@Parcelize
data class OrderHistoryResponse(@SerializedName("data")
...
@Parcelize
data class Products(@SerializedName("image")
                    val image: String = "",
...
@Parcelize
data class OrderHistoryDataItem(@SerializedName("offer_amount")
                    ...
                    val orderId: String = "",
                    @SerializedName("status")
                    val status: Int = 0):Parcelable

@Parcelize
data class Storedetail(@SerializedName("IsVerify")
                       val isVerify: Int = 0,
                       @SerializedName("city")
                       val city: String = "",
