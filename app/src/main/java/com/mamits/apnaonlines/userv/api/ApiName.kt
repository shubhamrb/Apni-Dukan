...
class ApiName {
    companion object {
        ...
        const val GET_DOCUMENTS: String = "api/auth/documentlist"
        ...
        const val VERIFY_VENDOR_CODE: String = "api/verifyVendorCode"
        ...
        const val ADD_DOCUMENT: String = "api/auth/addDocument"
        const val DELETE_DOCUMENT:String = "api/auth/documentDelete"
