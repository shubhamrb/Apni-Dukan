...
import com.mamits.apnaonlines.user.model.response.ChatListDataItem
...
class ChatMsgAdapter(
    ...
    var VIEW_OUTGOING = 2
    var mList: ArrayList<ChatListDataItem>? = ArrayList()
    ...
    fun refreshList(list: ArrayList<ChatListDataItem>){
        mList = list
        notifyItemRangeChanged(0, list?.size)
        notifyDataSetChanged()
    }

    fun setList(list: ArrayList<ChatListDataItem>){
        mList?.addAll(list)
        notifyDataSetChanged()
    }
